const questions = [
    ...
    {
        question: "The dictum \"even the bricks want to be something\" belongs to?",
        answers: {
    ...
    {
        question: "The dictum \"form and function are one\" belongs to?",
        answers: {
            a: "Frank Lloyd Wright",
            b: "Norman Foster",
            c: "Louis Khan",
    ...
    {
        question: "The dictum \"new situation requires a new architecture\" belongs to?",
        answers: {
            a: "Frank Lloyd Wright",
            b: "Norman Foster",
            c: "Louis Khan",
    ...
    {
        question: "The dictum \"architecture is an expression of values\" belongs to?",
        answers: {
            a: "Frank Lloyd Wright",
            b: "Norman Foster",
            c: "Louis Khan",
    ...
    {
        question: "The dictum \"God is in the details\" belongs to?",
        answers: {
    ...
    {
        question: "The dictum \"less is more\" belongs to?",
        answers: {
            a: "Ludwig Mies Van de Rohe",
            b: "Robert Venturi",
            c: "Eileen Gray",
    ...
    {
        question: "The dictum \"to create, one must question everything\" belongs to?",
        answers: {
            a: "Ludwig Mies Van de Rohe",
            b: "Robert Venturi",
            c: "Eileen Gray",
    ...
    {
        question: "The dictum \"less is bore\" belongs to?",
        answers: {
            a: "Ludwig Mies Van de Rohe",
            b: "Robert Venturi",
            c: "Eileen Gray",
    ...
    {
        question: "The dictum \"form ever follows  function\" belongs to?",
        answers: {
            a: "Ludwig Mies Van de Rohe",
            b: "Robert Venturi",
            c: "Eileen Gray",
    ...
    {
        question: "The dictum \"architecture seizes upon space, encompasses space and is space itself\" belongs to _____",
        answers: {
            a: "Oscar Niemeyer",
    ...
    {
        question: "The dictum \"lack of ornamentation is a sign of spiritual strength\" belongs to _____",
        answers: {
            a: "Oscar Niemeyer",
            b: "Frank Lloyd Wright",
            c: "Erich Mendelsohn",
    ...
    {
        question: "The dictum \"form follows beauty\" belongs to _____",
        answers: {
            a: "Oscar Niemeyer",
            b: "Frank Lloyd Wright",
            c: "Erich Mendelsohn",
    ...
    {
        question: "The dictum \"less is only more where more is no good\" belongs to _____",
        answers: {
            a: "Oscar Niemeyer",
            b: "Frank Lloyd Wright",
            c: "Erich Mendelsohn",
    ...
    {
        question: "The dictum \"less is more\" belongs to_____",
        answers: {
            a: "Oscar Niemeyer",
            b: "Frank Lloyd Wright",
            c: "Erich Mendelsohn",
    ...
    {
        question: "Who is the outstanding professional of the year?",
        answers: {
            a: "Robert Sac",
            b: "Yolanda Reyes",
            c: "Gerard Lico",
    ...
    {
        question: "Who is the likha gold awardee?",
        answers: {
            a: "Robert Sac",
            b: "Yolanda Reyes",
            c: "Gerard Lico",
    ...
    {
        question: "Who is the recent eric nubla awardee?",
        answers: {
            a: "Robert Sac",
            b: "Jose Recio",
            c: "Gerard Lico",
    ...
    },
    {
        ...
        answers: {
            a: "Carlos Baretto",
            b: "Juan Nakpil",
            c: "Felix Roxas Arroyo",
            d: "Tomas Mapua"
        },
        correctAnswer: "d"
    },
    {
        question: "First filipino architect who was schooled in London and began his architectural practice in 1858",
        answers: {
            a: "Carlos Baretto",
            b: "Juan Nakpil",
            c: "Felix Roxas Arroyo",
    ...
    {
        question: "First national artist for architecture in the year 1973",
        answers: {
            a: "Juan Arellano",
            b: "Angel Nakpil",
            c: "Tomas Mapua",
    ...
    {
        question: "First likha awardee in 1982",
        answers: {
            a: "Leandro Locsin",
            b: "Gabriel Formoso",
            c: "Cesar Canchela",
    ...
    {
        question: "Architect of the art deco Crystal Arcade in Escolta, Manila",
        answers: {
            a: "Andres Bonifacio",
            b: "Andres Luna de San Pedro",
            c: "Pablo Antonio",
            d: "Antonio Toledo"
        },
        correctAnswer: "b"
    ...
    {
        question: "Who is the architect of the Tokyo Metropolitan Government?",
        answers: {
            a: "Kengo Kuma",
            b: "Kisho Kurokawa",
            c: "Kenzo Tange",
    ...
    {
        "question": "The proponent of the Greater London Plan in 1944.",
        "answers": {
            "a": "John Gwynn",
            "b": "Norman Foster",
            "c": "Richard Rogers",
    ...
    {
        "question": "He introduced the concept of 'region' to architecture and planning and coined the term 'conurbation'.",
        "answers": {
            "a": "Patrick Geddes",
            "b": "Chauncy Harris",
            "c": "Ernest Burgess",
    ...
    ,
    {
        "question": "The proponent of the Garden City Movement.",
        "answers": {
            "a": "Ebenezer Howard",
            "b": "Chauncy Harris",
            "c": "Ernest Burgess",
    ...
    ,
    {
        "question": "The proponent of the City Beautiful Movement.",
        "answers": {
            "a": "Ebenezer Howard",
            "b": "Chauncy Harris",
            "c": "Ernest Burgess",
    ...
    ,
    {
        "question": "The dictum, 'postmodern architecture is characterized by a 'doubling code': two or more styles which coexist in contradiction and/or self-mockery' belongs to?",
        "answers": {
            "a": "Richard Neutra",
            "b": "Peter Behrens",
    ...
    {
        "question": "The dictum, 'architects must have a razor-sharp sense of individuality' belongs to?",
        "answers": {
            "a": "Richard Neutra",
            "b": "Peter Behrens",
            "c": "Ludwig Mies Van de Rohe",
    ...
    {
        "question": "The dictum, 'nothing is as dangerous in architecture as dealing with separated problems. If we split life into separated problems we split the possibilities to make good building art' belongs to?",
        "answers": {
            "a": "Alvar Aalto",
            "b": "Peter Behrens",
            "c": "Ludwig Mies Van de Rohe",
    ...
    {
        "question": "The dictum, 'Design is not about decorating functional forms - it is about creating forms that accord with the character of the object and that show new technologies to advantage' belongs to?",
        "answers": {
            "a": "Alvar Aalto",
            "b": "Peter Behrens",
            "c": "Ludwig Mies Van de Rohe",
    ...
    {
        "question": "Who is the father of regional town planning, who wrote the 'Cities in Evolution'?",
        "answers": {
            "a": "C.A. Doxiadis",
            "b": "Patrick Geddes",
            "c": "Ebenezer Howard",
    ...
    {
        "question": "Greek Architect-Engineer who described cities as urban nightmares, irrational arteries, congested streets, pollution and environmental degradation, lack of sufficient housing, facilities and services are poor.",
        "answers": {
            "a": "C.A. Doxiadis",
            "b": "Patrick Geddes",
            "c": "Ebenezer Howard",
    ...
    {
        "question": "He wrote the book 'Garden Cities of Tomorrow'.",
        "answers": {
            "a": "C.A. Doxiadis",
            "b": "Patrick Geddes",
            "c": "Ebenezer Howard",
    ...
    {
        "question": "The father of modernism and father of skyscrapers.",
        "answers": {
    ...
    {
        "question": "His works are called 'skin and bones' and is famous for the dictum 'less is more'.",
        "answers": {
            "a": "Frank Lloyd Wright",
            "b": "Frank Gehry",
            "c": "Richard Neutra",
